...
export default function Hero() {
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-center bg-[url(/hero/new-hero-bg.png)] bg-cover bg-center">
      <h1 className="text-6xl md:text-7xl max-w-1/2 mb-6 text-coffee-900">
        "Some People Be So Focused On The Cheese, They Forget About The Trap"
      </h1>
      <p className="text-lg md:text-xl max-w-2xl text-coffee-900 font-sans mb-8">
